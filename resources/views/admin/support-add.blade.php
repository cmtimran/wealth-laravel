            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href=""> Our Support Page Settings</a>
                        <li class="active-bre"><a href=""> Add New Supports</a>
                        </li>
                        <li class="page-back"><a href="support-all"><i class="fa fa-backward" aria-hidden="true"></i> View All supports</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <form>
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <label for="list-title">Supporter Name</label>
                                    </div>
                                </div>  
                                <div class="row">
                                    <div class="input-field col s12">
                                    ...
                                    <div class="input-field col s12">
                                        <div class="file-field">
                                            ...
                                            <div class="file-path-wrapper">
                                                <input class="file-path validate" type="text" placeholder="Upload Support Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
