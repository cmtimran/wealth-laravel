...
<body>
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> All Supports</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-1">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>24 may, 2017</td>
                                <td><a href="support-edit" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
    ...
    <section>
        <div class="fixed-action-btn vertical">
            <a href="support-add" class="btn-floating btn-large red pulse">
