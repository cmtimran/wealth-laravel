            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href=""> Blog Settings</a>
                        <li class="active-bre"><a href="blog-add"> Add New Post</a>
                        </li>
                        <li class="page-back"><a href="blog-all"><i class="fa fa-backward" aria-hidden="true"></i> View All Post</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="box-inn-sp">
                        ...
                        <div class="bor">
                            <form>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <textarea id="textarea1" class="materialize-textarea" placeholder="Max 120 Characters"></textarea>
                                        <label for="textarea1">Short Descriptions:</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <textarea id="textarea1" class="materialize-textarea" placeholder="Max 1200 Characters"></textarea>
