            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Our Support Section</a> </li>
                        <li class="active-bre"><a href="#"> Add New Support</a> </li>
                        <li class="page-back"><a href="slide-see-all"><i class="fa fa-backward" aria-hidden="true"></i> View Supporters</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="bor">
                            <form>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="list-title" type="text" class="validate">
                                        <label for="textarea1">ALT Tag</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s12">
